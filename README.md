...
Если вы хотите создать новую сессию, не обязательно удалять предыдущую. Вы можете просто начать новую сессию с помощью команды /start, и активная сессия будет заменена!
